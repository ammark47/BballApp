...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">100% <small>(170 / 170)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">94.3% <small>(182 / 193)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(32 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(170 / 170)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
function lineToPath(attributes) {
  ...
  return '' +
  'M' + (parseFloat(attributes.x1,10)||<span class="branch-1 cbranch-no" title="branch not covered" >0)</span>.toString(10) +
  ' ' + (parseFloat(attributes.y1,10)||<span class="branch-1 cbranch-no" title="branch not covered" >0)</span>.toString(10) +
  ' ' + ((parseFloat(attributes.x1,10)||<span class="branch-1 cbranch-no" title="branch not covered" >0)</span>+1).toString(10) +
  ' ' + ((parseFloat(attributes.y1,10)||<span class="branch-1 cbranch-no" title="branch not covered" >0)</span>+1).toString(10) +
  ' ' + ((parseFloat(attributes.x2,10)||<span class="branch-1 cbranch-no" title="branch not covered" >0)</span>+1).toString(10) +
  ' ' + ((parseFloat(attributes.y2,10)||<span class="branch-1 cbranch-no" title="branch not covered" >0)</span>+1).toString(10) +
  ' ' + (parseFloat(attributes.x2,10)||<span class="branch-1 cbranch-no" title="branch not covered" >0)</span>.toString(10) +
  ' ' + (parseFloat(attributes.y2,10)||<span class="branch-1 cbranch-no" title="branch not covered" >0)</span>.toString(10) +
  'Z';
}
&nbsp;
&nbsp;
...
&nbsp;
  ...
  this._transform = function _svgIcons2SVGFontStreamTransform(
    ...
    var parents = [];
    var glyph = svgIconStream.metadata || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    glyph.d = [];
    glyphs.push(glyph);
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Jun 07 2015 08:35:42 GMT+0200 (CEST)</div>
</div>
